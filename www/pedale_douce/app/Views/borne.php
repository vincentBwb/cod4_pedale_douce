...
<main>
    ...
    <div class="profile">
        ...
        <form class="map" method="POST" action="/borne">
            ...
            <div class="editPanel">
                ...
                <input type="submit" class="classBtn editPanelBtn orangeBtn" value="<?= $viewCfg["submitBtn"]; ?>">
        ...
        <div class="legend">
            ...
            <p class="blueBtn">Station with borne available</p>
            <p class="redBtn">Station with borne unavailable</p>
